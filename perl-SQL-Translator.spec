...
Source0  : https://cpan.metacpan.org/authors/id/V/VE/VEESH/SQL-Translator-1.65.tar.gz
...
%prep
%setup -q -n SQL-Translator-1.65
cd %{_builddir}/SQL-Translator-1.65
pushd ..
cp -a SQL-Translator-1.65 buildavx2
popd
